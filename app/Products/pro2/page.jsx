    ...
    <div className="min-h-screen text-white overflow-x-hidden">1
      ...
      <div className="flex flex-col items-center justify-center py-5 px-4 sm:px-6 lg:px-8">
        ...
        <motion.h1
          ...
          variants={fadeIn}
        >
         Swan 2 Chute (128 Channels) box type
        </motion.h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                >
                  ...
                  <ul className="space-y-3">
                    {[
                      { icon: FaSort, label: "channels", value: "128" },
                      { icon: FaBolt, label: " Sorting Capacity", value: " 200 - 3000 kg/hr" },
                      { icon: FaCompress, label: "Accuracy", value: "≥99.9%" },

                      { icon: FaBolt, label: "Power Voltage", value: "230V / 2.6A" },
                      { icon: FaCompress, label: "Air Source Pressure", value: "2-6 Bar" },
                      { icon: FaWeightHanging, label: " Compressor Powe", value: "10 Hp" },
                      { icon: FaRuler, label: "Dimensions", value: "1200×1550×1800 mm" },
                    ].map((item, index) => (
                      <motion.li
                        key={index}
