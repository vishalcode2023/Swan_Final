              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                >
                  ...
                  <ul className="space-y-3">
                    {[
                      { icon: FaSort, label: "channels", value: "512" },
                      { icon: FaBolt, label: " Sorting Capacity", value: "750 - 7500 kg/hr" },
                      ...
                      { icon: FaWeightHanging, label: " Compressor Power", value: "40 HP" },
                      { icon: FaRuler, label: "Dimensions", value: "3075×1550×1800 mm" },
                    ].map((item, index) => (
                      <motion.li
                        key={index}
